    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      ...
      <Card>
        <CardContent className="flex flex-col gap-6 py-6 text-sm leading-relaxed">
          <p>
            A GÊNEZI Educação Profissional (&quot;GÊNEZI&quot;, &quot;nós&quot;), inscrita em
            Propriá/SE, respeita a privacidade de alunos, candidatos e visitantes e trata os
            dados pessoais em conformidade com a Lei nº 13.709/2018 (Lei Geral de Proteção de
            Dados Pessoais — LGPD). Esta política explica quais dados coletamos, por que
            coletamos e quais direitos você tem sobre eles.
          </p>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              desatualizados, anonimização ou exclusão de dados desnecessários, portabilidade a
              outro fornecedor e revogação do consentimento. Veja a página{" "}
