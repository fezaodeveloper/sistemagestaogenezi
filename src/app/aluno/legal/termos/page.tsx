...
export default async function TermosDeUsoPage() {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      ...
      <Card>
        <CardContent className="flex flex-col gap-6 py-6 text-sm leading-relaxed">
          <p>
            Estes Termos de Uso regulam o acesso e uso do portal do aluno da GÊNEZI Educação
            Profissional. Ao acessar sua conta, você concorda com as regras descritas abaixo.
          </p>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              disponibilizado (videoaulas, materiais, provas) destina-se exclusivamente ao uso
              do aluno matriculado, para fins de estudo.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              propriedade da GÊNEZI ou de seus licenciadores, protegido por direitos autorais.
              É vedada a reprodução, distribuição, download não autorizado ou publicação desse
              material fora da plataforma, integral ou parcialmente, sem autorização expressa.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              discriminatórias, tentativas de fraude em avaliações ou uso indevido de contas de
              terceiros. Violações podem resultar em advertência, suspensão de acesso ou
              cancelamento da matrícula, conforme o regimento interno da escola.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              encerrar, trancar ou cancelar a matrícula, o acesso ao conteúdo do curso pode ser
              suspenso, ressalvados os documentos (certificados, histórico) que a escola deva
              manter disponíveis por obrigação legal ou contratual.
            </p>
          </section>
        </CardContent>
      </Card>
