      ...
      <Card>
        <CardContent className="flex flex-col gap-6 py-6 text-sm leading-relaxed">
          <p>
            ...
            vídeos) captada durante atividades da GÊNEZI Educação Profissional, em Propriá/SE.
          </p>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              presenciais, o aluno autoriza — de forma gratuita e não exclusiva — que a GÊNEZI
              capte e utilize sua imagem em fotografias e vídeos.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              A imagem não será utilizada para fins comerciais de terceiros, nem de forma que
              associe o aluno a conteúdo depreciativo ou alheio à finalidade educacional da
              GÊNEZI.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              O aluno pode revogar esta autorização a qualquer momento, mediante solicitação
              formal à administração pelo formulário da página{" "}
