...
import { CreditCard, GraduationCap, LayoutGrid, Mail, MessageCircle, Palette } from "lucide-react";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="outline" render={<Link href="/admin/configuracoes/personalizacao" />} nativeButton={false}>
            <Palette />
            Personalização
          </Button>
          ...
          <Button variant="outline" render={<Link href="/admin/configuracoes/apps" />} nativeButton={false}>
            <LayoutGrid />
            Apps
          </Button>
          ...
          <Button variant="outline" render={<Link href="/admin/configuracoes/whatsapp" />} nativeButton={false}>
            <MessageCircle />
            WhatsApp
          </Button>
