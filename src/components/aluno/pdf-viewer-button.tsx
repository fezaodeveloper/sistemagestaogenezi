...
import { getPdfSignedUrl } from "@/app/aluno/cursos/[id]/modulos/[moduloId]/aulas/[aulaId]/actions";
...
export function PdfViewerButton({ materialId, titulo }: { materialId: string; titulo: string }) {
  ...
  function handleOpenChange(nextOpen: boolean) {
    ...
    startTransition(async () => {
      const result = await getPdfSignedUrl(materialId);
      setState(
        "error" in result
