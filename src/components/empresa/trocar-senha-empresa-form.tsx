...
import { trocarSenhaEmpresa } from "@/app/empresa/(protegido)/perfil/actions";
...
// Mesmo padrão de trocar-senha-form.tsx (portal do aluno) — só o mínimo de
// caracteres muda (8, mesma regra do cadastro de empresa).
export function TrocarSenhaEmpresaForm() {
  ...
  function handleSubmit(event: FormEvent) {
    ...
    startTransition(async () => {
      const resultado = await trocarSenhaEmpresa(senhaAtual, novaSenha);
      if (resultado.error) {
