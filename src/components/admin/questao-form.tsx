...
import type { QuestaoFormState } from "@/app/admin/cursos/[id]/modulos/[moduloId]/aulas/[aulaId]/quiz/questoes/actions";
...
export function QuestaoForm({
  ...
  action: (state: QuestaoFormState, formData: FormData) => Promise<QuestaoFormState>;
  defaultValues?: {
    tipo?: Tipo;
    enunciado?: string;
    ordem?: number | string;
  ...
  const [state, formAction] = useActionState<QuestaoFormState, FormData>(action, undefined);
