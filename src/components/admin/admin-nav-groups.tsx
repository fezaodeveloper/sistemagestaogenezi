...
import {
  AlertTriangle, Award, CreditCard, LayoutGrid, Banknote, BarChart2, Bell, Briefcase, Building2, CalendarCheck, CalendarDays, CalendarRange, Camera, ChevronRight, ClipboardCheck, ClipboardList, Code2, FileBadge, FileSignature, FileText, Gift, GraduationCap, IdCard,
...
const GROUPS: NavGroup[] = [
  ...
  { id: "conecta", label: "Gênezi Conecta", icon: Building2, items: [
    ...
    { href: "/admin/conecta/cidades", label: "Cidades", icon: MapPin },
  ]},
  ...
  { id: "notificacoes", label: "Notificações", icon: Bell, items: [
    { href: "/admin/notificacoes", label: "Enviar notificação", icon: Bell },
  ]},
...
function isItemActive(pathname: string, href: string) {
  ...
  // "Configurações" e "Gateways" (subpágina) são itens irmãos: sem isto os dois
  // ficariam destacados dentro de /admin/configuracoes/gateways.
  if (href === "/admin/configuracoes") return pathname === href;
