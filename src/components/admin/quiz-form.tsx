...
import type { QuizFormState } from "@/app/admin/cursos/[id]/modulos/[moduloId]/aulas/[aulaId]/quiz/actions";
...
export function QuizForm({
  ...
  const [state, formAction] = useActionState<QuizFormState, FormData>(action, undefined);
